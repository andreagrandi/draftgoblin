...
[nuitka]
mode = onefile
extra_args = --quiet --noinclude-qt-translations --company-name=Draftgoblin --product-name=Draftgoblin --file-version=0.2.0 --product-version=0.2.0 --macos-app-name=Draftgoblin --macos-app-version=0.2.0 --macos-signed-app-name=io.github.andreagrandi.draftgoblin
macos.permissions =
